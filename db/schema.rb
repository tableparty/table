...
ActiveRecord::Schema.define(version: 2021_05_03_092158) do
  ...
  create_table "fog_areas", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "map_id", null: false
    t.string "path", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["map_id"], name: "index_fog_areas_on_map_id"
  end
  ...
  create_table "maps", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "fog_enabled", default: false, null: false
  ...
  add_foreign_key "fog_areas", "maps"
